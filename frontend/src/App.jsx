...
// In production the backend also serves this frontend build, so same-origin
// is the correct default. Set VITE_BACKEND_URL only for local development
// (pointing at localhost) or if you ever split frontend/backend hosting.
