        ...
        <div className="min-h-screen flex items-center justify-center bg-[#0B0E14] bg-grid relative overflow-hidden font-sans">
            ...
            >
                <div className="flex justify-center mb-8">
                    <div className="p-3 bg-purple-500/10 rounded-xl border border-purple-500/20 glow-border">
                        <Code2 className="w-8 h-8 text-purple-400" />
                    </div>
                </div>

                <h2 className="text-3xl font-bold text-center text-white mb-2">Create Account</h2>
                <p className="text-slate-400 text-center mb-8">Join CodeSync AI today</p>
